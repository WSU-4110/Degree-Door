export default function ConnectionSuccessDialog({ setOpenSuccess }) {
  return (
    <div className="flex absolute left-0 right-0 ml-auto mr-auto items-center p-4 w-[350px] text-gray-500 bg-white rounded-lg border border-gray-100 shadow-sm" role="alert">
      ...
      <div className="ml-3 text-sm font-normal">Message has successfully submitted!</div>
