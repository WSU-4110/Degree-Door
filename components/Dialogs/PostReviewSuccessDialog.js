export default function PostReviewSuccessDialog( { setOpenSuccess }) {
  return (
    <div className="flex items-center p-4 m-auto my-10 mt-[-60px] w-[350px] text-gray-500 bg-white rounded-lg border border-gray-100 shadow-sm" role="alert">
